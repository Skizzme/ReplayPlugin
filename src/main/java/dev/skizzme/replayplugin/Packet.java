...
public class Packet {
    ...
    public boolean isRespawn() {
        return isSending() && packetId == PacketType.Play.Server.RESPAWN;
     }
    ...
    public boolean isBlockPlace() {
        return isReceiving() && packetId == PacketType.Play.Client.USE_ITEM;
    }
    ...
    public boolean isUpdateHealth() {
        return isSending() && packetId == PacketType.Play.Server.UPDATE_HEALTH;
    }
    ...
    public boolean isChat() { return isReceiving() && packetId == PacketType.Play.Client.CHAT; }
